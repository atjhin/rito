...
class Logger:
    """Logger for exporting and managing LangGraph checkpoints."""
    ...
    def export_and_save_checkpoints_to_s3(self, db_path):
            ...
            try:
                ...
                for i, checkpoint_tuple in enumerate(checkpoints):
                    ...
                    record = {
                        ...
                        "checkpoint_id": checkpoint_config.get("configurable", {}).get(
                            "checkpoint_id", "N/A"
                        ),
        ...
        pretty_json_file = os.path.join(
            self.log_dir, f"langgraph_checkpoints_{timestamp}_pretty.json"
        )
        ...
        pickle_file = os.path.join(
            self.log_dir, f"langgraph_checkpoints_{timestamp}.pkl"
        )
        ...
        try:
            ...
            pretty_json_str = json.dumps(
                all_checkpoints, indent=2, default=str, ensure_ascii=False
            )
