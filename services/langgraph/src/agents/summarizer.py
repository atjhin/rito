...
class SummarizerAgent(Agent):
    ...
    def _init_human_message(self) -> HumanMessage:
        """Returns the human message defining the summarization format."""
        prompt = """
